...
class FacilityInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FacilityInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FacilityInput:
        """Create an instance of FacilityInput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return FacilityInput.parse_obj(obj)

        _obj = FacilityInput.parse_obj({

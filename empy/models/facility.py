...
class Facility(BaseModel):
    ...
    ip_ranges: Optional[List[StrictStr]] = Field(None, description="IP ranges registered in facility. Can be used for GeoIP location")
    metro: Optional[DeviceMetro] = None
    name: Optional[StrictStr] = None
    href: Optional[StrictStr] = None
    __properties = ["address", "code", "features", "id", "ip_ranges", "metro", "name", "href"]
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Facility:
        """Create an instance of Facility from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return Facility.parse_obj(obj)

        _obj = Facility.parse_obj({

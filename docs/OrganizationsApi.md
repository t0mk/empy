...
with empy.ApiClient(configuration) as api_client:
    ...
    api_instance = empy.OrganizationsApi(api_client)
    organization_input = empy.OrganizationInput() # OrganizationInput | Organization to create
...
with empy.ApiClient(configuration) as api_client:
    ...
    project_create_input = empy.ProjectCreateInput() # ProjectCreateInput | Project to create

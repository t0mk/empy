...
with empy.ApiClient(configuration) as api_client:
    ...
    api_instance = empy.ProjectsApi(api_client)
    project_create_from_root_input = empy.ProjectCreateFromRootInput() # ProjectCreateFromRootInput | Project to create
...
with empy.ApiClient(configuration) as api_client:
    ...
    api_instance = empy.ProjectsApi(api_client)
    id = 'id_example' # str | Project UUID
    project_update_input = empy.ProjectUpdateInput() # ProjectUpdateInput | Project to update
